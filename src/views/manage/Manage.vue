            ...
            <template>
              <div> 
                <el-row>
                  ...
                  <el-button type="primary" style="height: 40px" @click="searchput1">
                    <i class="el-icon-search"/></el-button>
                </el-row>
              </div>
              <el-table height="600" :data="tables1[0].slice(
                ...
                <el-table-column label="商品分类" prop="type">
                  ...
                  <template slot-scope="ShelvesData" >
          ...
          <el-tab-pane label="已下架商品" name="second">
            <template>
              ...
              <el-table height="480" :data="tables2[0].slice(
                ...
                <el-table-column label="商品价格" prop="price">
                  <template slot-scope="TakedownData" >
